          ...
          {applicant.isPrimary ? (
            ...
            <>
              <button
                ...
                title="As the account holder you can complete this profile on their behalf"
              >
                Complete on Behalf <ArrowRight className="h-3.5 w-3.5" />
              </button>
              <button
                onClick={onResend}
                className="inline-flex items-center justify-center gap-1.5 rounded-md border border-input bg-background px-2.5 py-2 text-xs font-medium text-foreground hover:bg-muted"
                title="Resend Invite"
              >
