...
export const Route = createFileRoute("/portal/tools/scenario-compare")({
  ...
  component: scenario_compare_Tool,
});

function scenario_compare_Tool() {
  ...
  return (
    <ToolPageShell
      ...
      onSave={() => saveScenario({ tool: "Mortgage Scenario Compare", name: `${fmtMoney(a)} estimate`, inputs: { a, b }, outputs: { result } })}
