...
export const Route = createFileRoute("/portal/tools/debt-consolidation")({
  ...
  component: debt_consolidation_Tool,
});

function debt_consolidation_Tool() {
  ...
  return (
    <ToolPageShell
      ...
      onSave={() => saveScenario({ tool: "Debt Consolidation Calculator", name: `${fmtMoney(a)} estimate`, inputs: { a, b }, outputs: { result } })}
