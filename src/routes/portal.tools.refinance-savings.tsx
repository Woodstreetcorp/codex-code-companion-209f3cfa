...
export const Route = createFileRoute("/portal/tools/refinance-savings")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "See if refinancing could lower your payment, consolidate debt, or unlock equity." },
    ],
  }),
  component: refinance_savings_Tool,
});

function refinance_savings_Tool() {
  ...
  return (
    <ToolPageShell
      ...
      subtitle="See if refinancing could lower your payment, consolidate debt, or unlock equity."
      bestFor="existing homeowners"
      onReset={() => { setA(100000); setB(5); }}
      onSave={() => saveScenario({ tool: "Refinance Savings Calculator", name: `${fmtMoney(a)} estimate`, inputs: { a, b }, outputs: { result } })}
