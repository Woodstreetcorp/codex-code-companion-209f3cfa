...
export const Route = createFileRoute("/portal/tools/prepayment")({
  ...
  component: prepayment_Tool,
});

function prepayment_Tool() {
  ...
  return (
    <ToolPageShell
      ...
      onSave={() => saveScenario({ tool: "Mortgage Prepayment Calculator", name: `${fmtMoney(a)} estimate`, inputs: { a, b }, outputs: { result } })}
