  ...
  return (
    <ApplicationShell summary={summary} tab="snapshot">
      ...
      <div className="mb-6 flex flex-col gap-3 rounded-2xl border border-secondary/30 bg-gradient-to-br from-secondary/10 via-card to-primary/5 p-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link to="/portal/applications/$applicationId/conditions" params={{ applicationId }} className="inline-flex items-center justify-center rounded-md bg-primary px-3.5 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">
          View open items <ArrowRight className="ml-1 h-4 w-4" />
        </Link>
      </div>

      <div className="grid gap-4 md:grid-cols-3">
        <Tile to="/portal/applications/$applicationId/offers" applicationId={applicationId} icon={BadgeCheck} title="Mortgage Offers" body="Compare lender offers tied to this application." />
        <Tile to="/portal/applications/$applicationId/documents" applicationId={applicationId} icon={FileText} title="Documents" body={`${summary.documentsPending} pending · view requests and uploads.`} />
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          <Link to="/portal/applications/$applicationId/qualification-summary" params={{ applicationId }} className="mt-3 inline-flex items-center text-xs font-semibold text-primary hover:text-primary/80">
        ...
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          <Link to="/portal/applications/$applicationId/messages" params={{ applicationId }} className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-primary hover:text-primary/80">
